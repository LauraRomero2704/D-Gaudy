<%-- 
    Document   : MisPersonalizaciones
    Created on : 21/11/2022, 09:00:34 PM
    Author     : Janus
--%>
...
<html>
    <head>
        ...
        <title>Mis Personalizaciones</title>
    </head>
    <body>
        <!-- Header -->
        <nav id="navbar">
        ...
        <div class="container mt-4">
            <div class="row">
                <%                      PersonalizaVO p = new PersonalizaVO();
                    ...
                    if (usuvo.getNom_usu() != null) {
                        List personal = peddao.misPerso(clientevo.getIde_cli());
                        for (int i = 0; i < personal.size(); i++) {
                            p = (PersonalizaVO) personal.get(i);
                    ...
                    <div class="form-group">
                        <div class="card">
                            <div class="card-header">
                                <center><label class="col-sm-13" style="font-family: fuenteTitulo;font-size: 25px;"><%=p.getNom_pers()%></label></center>                                    
                            </div>
                            <div class="card-body center d-flex">
                                <img src="<%=p.getUrlDiseño_pers()%>" width="450" height="290">
                            </div>
                            <div class="card-body2 text-center">
                                <label style="font-family: fuenteParrafo;font-size: 20px;"><i class="fas fa-dollar-sign"><%=p.getPrecio_pers()%></i></label>                                    
                            </div>
                            <div class="card-footer">
                                <div class="col-sm-12" >
                                    <center>  <label style="font-family: fuenteParrafo;font-size: 20px;"></label> </center>                                  
                                </div>


                                <div class=" col-sm-12 text-center">              
                                    <a href="CarritoController?accion=AgregarPersonalizacion&ide_pers=<%=p.getIde_pers()%>" style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-success"><i class="fas fa-cart-plus"></i> Agregar</a>
