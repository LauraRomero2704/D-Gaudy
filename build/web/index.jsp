                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class=" col-sm-12 text-center">              
                                        <a href="CarritoController?accion=AgregarCarrito&ide_pren=${p.getIde_pren()}" style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-success"><i class="fas fa-cart-plus"></i> Agregar</a>
                                        <br><br>
                                        <a href="CarritoController?accion=Comprar&ide_pren=${p.getIde_pren()}" style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-info"><i class="fa fa-rocket"></i> Realizar Pedido</a>
