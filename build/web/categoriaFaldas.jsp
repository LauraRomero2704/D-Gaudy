<%-- 
    Document   : categoriaFaldas
    Created on : 19/11/2022, 03:59:02 PM
    Author     : Janus
--%>
...
<html>
    ...
    <body>
     ...
     <div class="container mt-4">
            <div class="row">
                <c:forEach var="prenvo" items="${myFaldas}">
                    <div class="col-sm-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class=" col-sm-12 text-center">              
                                        <a href="CarritoController?accion=AgregarFalda&ide_pren=${prenvo.getIde_pren()}"  style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-success"><i class="fas fa-cart-plus"></i> Agregar</a>
                                        <br><br>
