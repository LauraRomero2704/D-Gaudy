<%-- 
    Document   : reportePrendas
    Created on : 13/10/2022, 06:39:09 PM
...
<html>
    ...
    <body>
        ...
        File jasperfile = new File(application.getRealPath("reportes/reportePrendas.jasper"));
