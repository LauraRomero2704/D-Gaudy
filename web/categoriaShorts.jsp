<%-- 
    Document   : categoriaShorts
    Created on : 15/11/2022, 06:55:23 PM
    Author     : Janus
--%>
...
<html>
    ...
    <body>
     ...
     <div class="container mt-4">
            <div class="row">
                <c:forEach var="prenvo" items="${myShorts}">
                   <div class="col-sm-4">
                        <div class="form-group">
                            <div class="card">
                                <div class="card-header">
                                  <center><label class="col-sm-13" style="font-family: fuenteTitulo;font-size: 25px;">${prenvo.getNom_pren()}</label></center>                                    
                                </div>
                                <div class="card-body center d-flex">
                                    <img src="${prenvo.getUrl_pren()}" width="450" height="290">
                                </div>
                                <div class="card-body2 text-center">
                                    <label style="font-family: fuenteParrafo;font-size: 20px;"><i class="fas fa-dollar-sign">${prenvo.getPrecio_pren()}</i></label>                                    
                                </div>
                                <div class="card-footer">
                                    <div class="col-sm-12" >
                                      <center>  <label style="font-family: fuenteParrafo;font-size: 20px;">${prenvo.getDescrip_pren()}</label> </center>                                  
                                    </div>
                                    <br>
                                    <div class=" col-sm-12 text-center">              
                                        <a href="CarritoController?accion=AgregarShort&ide_pren=${prenvo.getIde_pren()}" style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-success"><i class="fas fa-cart-plus"></i> Agregar</a>
                                         <br><br>
                                        <a href="CarritoController?accion=Comprar&ide_pren=${prenvo.getIde_pren()}" style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-info"><i class="fa fa-rocket"></i>  Realizar Pedido</a>
                                        <br><br>
                                        <a href="short2.jsp" style="font-family: fuenteTitulo;font-size: 25px;" class="btn btn-info"><i class="fa fa-rocket"></i> Personalizar</a>
