<%-- 
    Document   : carritoPers
    Created on : 22/11/2022, 05:12:09 PM
    Author     : Janus
--%>
...
<html>
    <head>
        ...
        <title>Carrito de Prendas Personalizadas</title>
    </head>
    <body>       
        <!-- Header -->
        <nav id="navbar">
        ...
        <div class="container mt-4">
                    ...
                    <div class="cart">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <c:forEach var="p" items="${CarritoPers}"> 
                                        <tr>
                                            <td>
                                                <div class="main">
                                                    <div class="d-flex">
                                                        <img src="${p.getUrlDiseño_pers()}" width="220" height="220">
                                                    </div>
                                                    <div >
                                                        <p style="font-family: fuenteParrafo; font-size: 20px;">${p.getNom_pers()}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 style="font-family: fuenteParrafo;font-size: 20px;">${p.getTotal_ped()}</h6>
                                            </td>
                                            <td>
                                                <div class="counter">
                                                    <input type="hidden" id="item2" value="${p.getIde_pers()}">
                                                    <input type="number" min="1" max="10"  id="CantPer" class=" form-control text-center" style="font-family: fuenteParrafo;font-size: 20px;" value="${p.getCantPren_det()}">
                                                </div>
                                            </td>
                                            <td>
                                                <h6 style="font-family: fuenteParrafo;font-size: 20px;">${p.getSubTotal_ped()}</h6>
                                            </td>
                                            <td class="text-center">                                         
                                                <input type="hidden" id="b4" value="${c.getIde_pers()}">
            ...
            <!-- Modal de Pago -->
            <c:forEach var="c" items="${CarritoPers}"> 
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-iniciar" role="tabpanel">
                                        <form method="post" action="CarritoController">
                                            ...
                                            <input type="hidden" name="accion" value="GenerarPedidoPers">
