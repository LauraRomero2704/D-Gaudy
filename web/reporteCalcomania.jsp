<%-- 
    Document   : reporteCalcomania
    Created on : 23/10/2022, 05:49:43 PM
...
<html>
    <head>
        ...
        <title>Reporte Calcomania</title>
    </head>
    <body>
        <%
        Connection con;
        ...
        File jasperfile = new File(application.getRealPath("reportes/reporteCalcomanias.jasper"));
